...
public class TweenDefinitions
    {
		...
		// Back     ---------------------------------------------------------------------------------------------------------------------------
		public static float EaseIn_Back(float t)
		{
			float c1 = 1.70158f;
			float c3 = c1 + 1f;
		...
		public static float EaseOut_Back(float t)
		{
			return 1 - EaseIn_Back(1 - t);
		}

		public static float EaseInOut_Back(float t)
		{
			if (t < 0.5f)
			{
				return EaseIn_Back(t * 2f) / 2f;
			}
			else
			{
				return 1 - EaseIn_Back((1f - t) * 2f) / 2f;
			}
		}
    }